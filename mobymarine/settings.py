"""
Django settings for mobymarine project.
...
SECRET_KEY = 'tc%=(1ng62nbyu3k)cxl(cqnb5s4(mpgoi1nv$@-87*iwkzs!c'
...
WSGI_APPLICATION = 'mobymarine.wsgi.application'
